...
use super::models::{DomainError, FileChange, FileVersion, VersionQuery, VersionedFile};
...
pub trait RepositoryFactory: Send + Sync {
    ...
    fn create_searchable_repository(
        &self,
    ) -> RepositoryResult<Box<dyn SearchableVersionRepository>>;
